...
gulp.task('styles', function () {
    return gulp.src(Config.paths.source.scss + '/fcm-imgupload-angular.scss')
        .pipe(sass())
        .pipe(prefix({ 
...
gulp.task('scripts-part-1', function () {
    return gulp.src([
        ...
        Config.paths.source.js + '/fcm-imgupload-angular.js'
    ])
        .pipe(concat('fcm-imgupload-angular' + '.js', {
            separator: '\n\n',
...
gulp.task('scripts-part-2', function () {
    return gulp.src([
        Config.paths.tmp + '/fcm-imgupload-angular' + '.js',
